...
ADMIN = {
    ...
    "b_adm_log": ("📜 گزارش ادمین", "📜 Admin log"),
    ...
    "b_to_free": ("🟢 تغییر به مود دسترسی عمومی", "🟢 Switch to Public Access"),
    "b_to_paid": ("💎 تغییر به مود دسترسی اشتراکی", "💎 Switch to Premium Access"),
    ...
    "f_all": ("همه", "All"),
    "f_sub": ("💎 دسترسی اشتراکی", "💎 Premium Access"),
    "f_exp": ("⌛ منقضی", "⌛ Expired"),
    ...
    "notified_later": ("⏳ کاربر هنوز ربات رو استارت نزده؛ با اولین ورودش پیام فعال‌سازی ارسال میشه", "⏳ the user hasn't started the bot yet; the activation message is sent on their first visit"),
    # ------------------------------------------------------------ خانه و آمار
    "adm_home": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n🔀 مود: <b>{mode}</b>\n👥 کاربران: <b>{users}</b>\n💎 اشتراک فعال: <b>{subs}</b>\n🚫 بن‌شده: <b>{banned}</b>\n🖥 نشست زنده: <b>{live}</b> از <b>{max}</b>", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n🔀 Mode: <b>{mode}</b>\n👥 Users: <b>{users}</b>\n💎 Active subs: <b>{subs}</b>\n🚫 Banned: <b>{banned}</b>\n🖥 Live sessions: <b>{live}</b> of <b>{max}</b>"),
    "adm_stats": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n📊 <b>آمار</b>\n\n🔀 مود: <b>{mode}</b>\n👥 کاربران: <b>{users}</b>\n💎 اشتراک فعال: <b>{subs}</b>\n🚫 بن‌شده: <b>{banned}</b>\n🖥 سرورهای ذخیره‌شده: <b>{hosts}</b>\n⚡ نشست ترمینال: <b>{live}</b>\n📁 نشست فایل: <b>{sftp}</b>\n🧠 رم بات: <b>{ram} MB</b>\n⏱ آپتایم: {uptime}", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n📊 <b>Stats</b>\n\n🔀 Mode: <b>{mode}</b>\n👥 Users: <b>{users}</b>\n💎 Active subs: <b>{subs}</b>\n🚫 Banned: <b>{banned}</b>\n🖥 Saved servers: <b>{hosts}</b>\n⚡ Terminal sessions: <b>{live}</b>\n📁 File sessions: <b>{sftp}</b>\n🧠 Bot RAM: <b>{ram} MB</b>\n⏱ Uptime: {uptime}"),
    "adm_cannot_self": ("👑 این کار روی ادمین ممکن نیست.", "👑 This can't be done to the admin."),
    "adm_new_user": ("🆕 <b>کاربر جدید</b>\n👤 {name} · {username}\n🆔 <code>{uid}</code>", "🆕 <b>New user</b>\n👤 {name} · {username}\n🆔 <code>{uid}</code>"),
    "adm_sub_expired": ("⌛ اشتراک کاربر <b>{name}</b> (<code>{uid}</code>) تموم شد.", "⌛ Subscription of <b>{name}</b> (<code>{uid}</code>) has expired."),
    # ------------------------------------------------------------ کاربران
    "adm_users_title": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n👥 <b>کاربران</b> ({total})\n💎 اشتراک · ⌛ منقضی · 🚫 بن · ⚪ بدون اشتراک", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n👥 <b>Users</b> ({total})\n💎 subscribed · ⌛ expired · 🚫 banned · ⚪ none"),
    "adm_user": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n👤 <b>{name}</b> · {username}\n🆔 <code>{uid}</code>\n📅 عضویت: {joined}\n👁 آخرین بازدید: {seen}\n🖥 سرورها: <b>{hosts}</b>\n🎟 اشتراک: {sub}\n🚫 بن: {banned}\n⚡ نشست زنده: {live}\n🤖 ربات رو استارت زده: {started}", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n👤 <b>{name}</b> · {username}\n🆔 <code>{uid}</code>\n📅 Joined: {joined}\n👁 Last seen: {seen}\n🖥 Servers: <b>{hosts}</b>\n🎟 Subscription: {sub}\n🚫 Banned: {banned}\n⚡ Live session: {live}\n🤖 Started the bot: {started}"),
    ...
    # ------------------------------------------------------------ اعطای اشتراک
    "adm_grant_ask_id": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n🎟 <b>اعطای اشتراک</b>\n\n🆔 <b>آیدی عددی</b> کاربر رو بفرست", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n🎟 <b>Grant access</b>\n\n🆔 Send the user's <b>numeric ID</b>"),
    "adm_grant_ask_days": ("🎟 کاربر <code>{uid}</code>\n\n⏳ <b>تعداد روز</b> اشتراک رو بفرست (1 تا 365)\n<i>اگه اشتراک فعال داره، روزها به باقی‌مانده اضافه می‌شه.</i>", "🎟 User <code>{uid}</code>\n\n⏳ Send the number of <b>days</b> (1–365)\n<i>If they already have an active plan, days are added to the remaining time.</i>"),
    "adm_grant_ask_hosts": ("🎟 کاربر <code>{uid}</code> · <b>{days}</b> روز\n\n🗄 <b>تعداد سرور</b> مجاز رو بفرست (1 تا 100)", "🎟 User <code>{uid}</code> · <b>{days}</b> days\n\n🗄 Send the allowed <b>number of servers</b> (1–100)"),
    "adm_granted": ("✅ <b>اشتراک اعمال شد</b>\n\n🆔 <code>{uid}</code>\n⏳ {days} روز · 🗄 {hosts} سرور\n📅 اعتبار تا: <b>{until}</b>\n\n{notified}", "✅ <b>Access granted</b>\n\n🆔 <code>{uid}</code>\n⏳ {days} days · 🗄 {hosts} servers\n📅 Valid until: <b>{until}</b>\n\n{notified}"),
    # ------------------------------------------------------------ مود
    "adm_mode": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n🔀 <b>مود ربات</b>\n\nمود فعلی: <b>{mode}</b>\n\n{note}", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n🔀 <b>Bot mode</b>\n\nCurrent mode: <b>{mode}</b>\n\n{note}"),
    "adm_mode_note_paid": ("با رفتن به «مود دسترسی اشتراکی»، فقط کاربرانی که اشتراک فعال دارن دسترسی خواهند داشت. بقیه قفل می‌شن (داده‌شون می‌مونه) و نشست‌هاشون بسته می‌شه.", "Switching to “Premium Access”: only users with an active plan keep access. Everyone else is locked (their data stays) and their sessions are closed."),
    "adm_mode_note_free": ("با رفتن به «مود دسترسی عمومی»، همه‌ی کاربران (به‌جز بن‌شده‌ها) بدون محدودیت اشتراک دسترسی دارن.", "Switching to “Public Access”: every user (except banned ones) has access with no subscription needed."),
    "adm_mode_changed": ("✅ مود ربات شد: <b>{mode}</b>", "✅ Bot mode is now: <b>{mode}</b>"),
    # ------------------------------------------------------------ پیام همگانی
    "adm_bc_audience": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n📢 <b>پیام همگانی</b>\nگیرنده‌ها کی باشن؟", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n📢 <b>Broadcast</b>\nWho should receive it?"),
    ...
    # ------------------------------------------------------------ کانال‌ها
    "adm_channels": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n📡 <b>کانال‌های جوین اجباری</b> ({n})\nروی هر کانال بزنی حذف می‌شه.", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n📡 <b>Forced-join channels</b> ({n})\nTap a channel to remove it."),
    "adm_channels_empty": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n📡 <b>جوین اجباری غیرفعاله</b>\nیک یا چند کانال اضافه کن تا کاربرها قبل از استفاده عضو بشن.", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n📡 <b>Forced join is off</b>\nAdd one or more channels that users must join first."),
    "adm_channel_ask": ("📡 آیدی کانال رو بفرست (مثل <code>@mychannel</code> یا آیدی عددی) یا یک پیام از اون کانال فوروارد کن.\n⚠️ ربات باید توی اون کانال <b>ادمین</b> باشه.", "📡 Send the channel (like <code>@mychannel</code> or its numeric ID) or forward a message from it.\n⚠️ The bot must be an <b>admin</b> in that channel."),
    ...
    "adm_restore_confirm": ("♻️ <b>بکاپ معتبره</b>\n\n👥 کاربران: <b>{users}</b>\n🖥 سرورها: <b>{hosts}</b>\n📅 ساخته‌شده: {when}\n\n⚠️ داده‌های فعلی جایگزین می‌شن. ادامه بدم؟", "♻️ <b>Valid backup</b>\n\n👥 Users: <b>{users}</b>\n🖥 Servers: <b>{hosts}</b>\n📅 Created: {when}\n\n⚠️ Current data will be replaced. Continue?"),
    ...
    # ------------------------------------------------------------ نشست‌ها، تنظیمات، لاگ
    "adm_sessions": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n🖥 <b>نشست‌های زنده</b>: {n} از {max}\nروی هر نشست بزنی بسته می‌شه.", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n🖥 <b>Live sessions</b>: {n} of {max}\nTap a session to close it."),
    "adm_settings": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n⚙️ <b>تنظیمات</b>\n\n🖥 سقف نشست زنده‌ی هم‌زمان: <b>{max}</b>\n⏳ بستن نشست بیکار: بعد از <b>{idle}</b> دقیقه\n⏱ حداکثر عمر هر نشست: <b>{life}</b> ساعت\n\n<i>سقف نشست‌ها رو با دکمه‌ها تغییر بده. بقیه از .env تنظیم می‌شن.</i>", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n⚙️ <b>Settings</b>\n\n🖥 Max concurrent live sessions: <b>{max}</b>\n⏳ Idle session timeout: <b>{idle}</b> min\n⏱ Max session lifetime: <b>{life}</b> h\n\n<i>Change the session cap with the buttons. Others are set in .env.</i>"),
    "adm_log": ("👑 <b>AtronixX-Core</b> · پنل مدیریت\n━━━━━━━━━━━━━━━━\n📜 <b>آخرین فعالیت‌های ادمین</b>", "👑 <b>AtronixX-Core</b> · Admin panel\n━━━━━━━━━━━━━━━━\n📜 <b>Recent admin activity</b>"),
